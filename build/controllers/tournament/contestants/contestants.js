...
router.route('/contestants')
    ...
    if (!err) {
        ...
        res.status(http_status_codes_1.default.INTERNAL_SERVER_ERROR).send(err instanceof my_error_1.default ? err.message : 'cannot join to the tournament');
    }
}))
    ...
    if (!(data instanceof Error)) {
        ...
        res.status(http_status_codes_1.default.UNAUTHORIZED).send(data instanceof my_error_1.default ? data.message : 'cannot retrieve tournament contestants list');
    }
}));
